			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<img class="img-fluid" src="{{url('user/assets/images/shoes2.jpg')}}" alt="">
						<div class="hover">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="/loginuser" method="post" id="contactForm" novalidate="novalidate">
						@csrf
